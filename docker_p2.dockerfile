...
RUN pip3 install tensorflow==2.3.0 #adding version
...
#RUN python3 -c "from notebook.auth.security import set_password; set_password('joeiscool', '/root/.jupyter/jupyter_lab_config.json')" 
